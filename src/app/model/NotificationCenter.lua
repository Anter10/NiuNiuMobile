...
function NotificationCenter:AddObserver( aiNotificationID, aiObserver, aiHandler )
	...
	print("aiNotificationIDaiNotificationIDaiNotificationID = ",aiNotificationID)
...
function NotificationCenter:PostNotification( aiNotificationID, aiData )
 print("come in postNotifaction  ", aiNotificationID,self.miNotificationList[aiNotificationID])
	if self.miNotificationList[aiNotificationID] == nil then
		-- print(":nil")
		-- Tools.showError("当前到达那儿了啊啊1")
		return
	end
    -- Tools.showError("1111当前到达那儿了啊啊2",10)
